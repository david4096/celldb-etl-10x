...
setup(
    ...
    packages=["celldb.etl.tenx"],
    namespace_packages=["celldb", "celldb.etl"],
    zip_safe=False,
    url="https://github.com/david4096/celldb-etl-10x",
    version=1.0,
    entry_points={
        'console_scripts': ["celldb-etl-10x=celldb.etl.tenx.tenx:main"]
    },
